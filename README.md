...
* [Задачи](#задачи)
   * [Node.js](#nodejs)
      ...
      * [Сложный:](#сложный)
         ...
         * [3. Node.js (Регулярные выражения - "Проверка формата строки и извлечение данных"):](#3-nodejs-регулярные-выражения---проверка-формата-строки-и-извлечение-данных)
   * [SQL](#sql)
      * [Лёгкий:](#лёгкий-1)
...
<!-- Added by: runner, at: Thu Nov 28 06:58:59 UTC 2024 -->
